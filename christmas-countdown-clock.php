...
function christmas_countdown_clock_init() 
{
	...
	if ( $_POST['christmas-countdown-clock-submit'] ) {
	     ...
	     $options_flag=1;
      	...
      	echo '<ul><li style="text-align:center;list-style: none;"><label for="christmas-countdown-clock-title">Christmas Countdown Clock<br> by <a href="https://mycountdown.org">mycountdown.org</a></label></li>';
